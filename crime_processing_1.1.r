...
#              Formats and aggregates geocoding outputs 
...
packages <- c("dplyr", "purrr", "readr", "stringr", "lubridate")
...
url <- "https://raw.githubusercontent.com/jamisoncrawford/Syracuse-Crime-Analysis/master/Data/syr_crime_2018-07_to_2018-11.csv"
...
geocode <- crime %>%                      # Initialize object "geocode"
...
setwd("~/CNYCF/Crime Analysis/crime_data")
write_csv(geocode, "crime_2018-06_to_2018-11.csv", col_names = FALSE)
...
url_1 <- "https://raw.githubusercontent.com/jamisoncrawford/Syracuse-Crime-Analysis/master/Data/geocode_output_2018-06_to_2018_11.csv"
...
sum(complete.cases(crime)) / nrow(crime)    # 90.94% exact matches
...
crime <- crime %>%
  filter(geoid %in% fips$geoid)         # Filtered 30 non-matching tracts
...
write_csv(crime_table, "crm_all_table_1.1.csv")
write_csv(larceny_table, "crm_larceny_table_1.1.csv")
write_csv(other_table, "crm_other_table_1.1.csv")

write_csv(crime, "crm_all_1.1.csv")
write_csv(larceny, "crm_larceny_1.1.csv")
write_csv(other, "crm_other_1.1.csv")
